//
//  UMOverdue60UnWriteoffReceiveViewController.m
//  vlogmb
//
...
#import "UMOverdue60UnWriteoffReceiveViewController.h"
#import "ASFTableView.h"
#import "UMAppDelegate.h"
#import "AFNetworking.h"
@interface UMOverdue60UnWriteoffReceiveViewController ()
@property (nonatomic, retain) NSMutableArray *rowsArray;
@end

@implementation UMOverdue60UnWriteoffReceiveViewController
...
-(void) listByOutDay
{
    ...
    NSString *string=[[[[UMAppDelegate basePath] stringByAppendingString:@"airorderBillingAction!listByOutDay.action?branchcompanyid="] stringByAppendingString:[branchcompanyid stringValue]] stringByAppendingString:@"&type=receive&overday=60"];
