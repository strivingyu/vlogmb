//
//  UMOverdue30UnWriteoffReceiveViewController.m
//  vlogmb
//
...
#import "UMOverdue30UnWriteoffReceiveViewController.h"
#import "ASFTableView.h"
#import "UMAppDelegate.h"
#import "AFNetworking.h"
@interface UMOverdue30UnWriteoffReceiveViewController ()
@property (nonatomic, retain) NSMutableArray *rowsArray;
@end

@implementation UMOverdue30UnWriteoffReceiveViewController
...
-(void) listByOutDay
{
    ...
    NSString *string=[[[[UMAppDelegate basePath] stringByAppendingString:@"airorderBillingAction!listByOutDay.action?branchcompanyid="] stringByAppendingString:[branchcompanyid stringValue]] stringByAppendingString:@"&type=receive&overday=30"];
