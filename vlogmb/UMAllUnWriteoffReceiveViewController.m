//
//  UMAllUnWriteoffReceiveViewController.m
//  vlogmb
//
...
#import "UMAllUnWriteoffReceiveViewController.h"
#import "ASFTableView.h"
#import "UMAppDelegate.h"
#import "AFNetworking.h"
@interface UMAllUnWriteoffReceiveViewController ()
@property (nonatomic, retain) NSMutableArray *rowsArray;
@end

@implementation UMAllUnWriteoffReceiveViewController
...
-(void) listByTypeAndStatus
{
    ...
    NSString *string=[[[[UMAppDelegate basePath] stringByAppendingString:@"airorderBillingAction!listByTypeAndStatus.action?branchcompanyid="] stringByAppendingString:[branchcompanyid stringValue]] stringByAppendingString:@"&type=receive&status=false"];
